    ...
    @if ($showPanel)
        <div class="fixed right-0 top-0 h-full w-96 bg-white/50 dark:bg-gray-800/90  notification-panel z-50 flex flex-col shadow-lg rounded-l-lg"
                            ...
                            <div
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-sm text-gray-600 dark:text-gray-300">
                                        <strong class="font-semibold text-gray-900 dark:text-white">{{ $notification['user_name'] }}</strong>
                                        {{ $notification['action'] }}
                                        <a href="#"
            ...
            <div
                ...
                <a href="#" class="btn btn-outline border-gray-300 dark:border-gray-600 dark:text-gray-300 btn-sm flex-1 ml-2">
                    See All
                </a>
            </div>
        </div>
