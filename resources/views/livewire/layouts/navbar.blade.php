                ...
                <div class="w-full">
                    ...
                    <div
                        ...
                        <a href="{{ route('admin.bookings') }}" wire:navigate
                            class="flex-1 py-3 text-center font-semibold  {{ request()->routeIs('admin.bookings') ? 'bg-white text-gray-800 shadow-sm' : 'text-gray-700 hover:bg-gray-200' }} rounded-lg focus:outline-none transition-colors duration-200 ease-in-out">
                            Bookings
                        </a>

                        <!-- Tab Item for Listings -->
                        <a href="{{ route('admin.listing-list') }}" wire:navigate
                            class="flex-1 py-3 text-center font-semibold {{ request()->routeIs('admin.listing-list') ? 'bg-white text-gray-800 shadow-sm' : 'text-gray-700 hover:bg-gray-200' }} rounded-lg focus:outline-none transition-colors duration-200 ease-in-out">
                            Listings
                        </a>

                        <!-- Tab Item for Events -->
                        <a href="{{ route('admin.event-list') }}" wire:navigate
                            class="flex-1 py-3 text-center font-semibold  {{ request()->routeIs('admin.event-list') ? 'bg-white text-gray-800 shadow-sm' : 'text-gray-700 hover:bg-gray-200' }} rounded-lg focus:outline-none transition-colors duration-200 ease-in-out">
                            Event
                        </a>
