    ...
    <div class="container mx-auto flex items-center justify-center min-h-full pt-10">
        <div class="w-full max-w-sm text-center">
            ...
            <input type="email" placeholder="Email"
                class="w-full px-4 py-4 bg-[#F8F6EE] border-[#c5a86a] rounded-md mb-4 focus:outline-none focus:ring-2 focus:ring-[#c5a86a]">

            <!-- Password Input -->
            <div class="relative mb-4">
                <input type="password" placeholder="Password"
                    class="w-full px-4 py-4 bg-[#F8F6EE] border border-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-[#c5a86a]">
            ...
            <!-- Login Button -->
            <button
                class="w-full bg-[#c5a86a] text-white font-medium py-4 rounded-md shadow-md hover:bg-[#b8964c] font-playfair transition shadow-[#c5a86a] ">
                Login
            </button>
        ...
        <!-- Square 2 (Rotated) -->
        <div
            class="absolute w-[372px] h-[372px] border-2 border-[#f3f0e6] opacity-100 bottom-0 left-[-177px] -rotate-[27.09deg] z-10">
        </div>
