        ...
        <div class="bg-[#E7E7E7] rounded-lg overflow-x-auto">
            <table class="min-w-full leading-normal">
                <thead>
                    <tr>
                        <th
                            class="px-5 py-3 border-b-2 border-gray-200 bg-[#E7E7E7] text-left text-sm font-semibold text-gray-900 uppercase tracking-wider">
                            ID
                        </th>
                        <th
                            class="px-5 py-3 border-b-2 border-gray-200 bg-[#E7E7E7] text-left text-sm font-semibold text-gray-900 uppercase tracking-wider">
                        ...
                        <th
                            class="px-5 py-3 border-b-2 border-gray-200 bg-[#E7E7E7] text-right text-sm font-semibold text-gray-900 uppercase tracking-wider">
                            ACTION
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">jonh@gmail.com</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">+6842341354</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">01/05/2025</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">**********</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">Pending</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <a href="#" class="text-blue-500 hover:text-blue-700">Send</a>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">Confirmed</p>
                        </td>
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <a href="#" class="text-blue-500 hover:text-blue-700">Send</a>
                        </td>
