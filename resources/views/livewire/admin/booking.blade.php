        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden mt-6">
            ...
            <div class="hidden md:block overflow-x-auto">
                <table class="min-w-full leading-normal">
                    <thead>
                        <tr>
                            <th class="px-5 py-3 text-left text-base font-medium text-black uppercase tracking-wider">
                                ID</th>
                            <th class="px-5 py-3 text-left text-base font-medium text-black uppercase tracking-wider">
                                MEMBER</th>
                            <th class="px-5 py-3 text-left text-base font-medium text-black uppercase tracking-wider">
                            ...
                            <th class="px-5 py-3 text-left text-base font-medium text-black uppercase tracking-wider">
                                STATUS</th>
                            <th class="px-5 py-3 text-center text-base font-medium text-black uppercase tracking-wider">
                                ACTIONS</th>
                        </tr>
                    </thead>
                    <tbody>
